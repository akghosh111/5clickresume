                        ...
                        <div className="mx-auto max-w-7xl px-6 md:px-12">
                            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                                <Link
                                    ...
                                    <span className="text-sm">Free Resume ATS score checker</span>
                                ...
                                <h1 className="mt-8 text-4xl font-semibold md:text-5xl xl:text-5xl xl:[line-height:1.125]">
                                    Create a clean, industry-ready resume<br /> in just 5 clicks
                                </h1>
                                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">Built for college students, fresh graduates, and junior developers.</p>
                                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">Edit, customize, save, and download your resume instantly — using the industry-recognized Jake’s Resume Template.</p>
